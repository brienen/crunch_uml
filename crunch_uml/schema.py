...
class Schema:
    ...
    def get_datatype(self, id):
        return self.database.session.query(db.Datatype).filter_by(id=id, schema_id=self.schema_id).first()
    ...
    def get_all_packages(self):
        return self.database.session.query(db.Package).filter_by(schema_id=self.schema_id).all()
    ...
    def get_all_datatypes(self):
        return self.database.session.query(db.Datatype).filter_by(schema_id=self.schema_id).all()

    def get_all_attributes(self):
        return self.database.session.query(db.Attribute).filter_by(schema_id=self.schema_id).all()

    def get_all_literals(self):
        return self.database.session.query(db.EnumerationLiteral).filter_by(schema_id=self.schema_id).all()
    ...
    def count_datatype(self):
        return self.database.session.query(db.Datatype).filter_by(schema_id=self.schema_id).count()
    ...
    def clean(self):
        ...
        self.database.session.query(db.Datatype).filter_by(schema_id=self.schema_id).delete()

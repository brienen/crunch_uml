...
1. **Phase 1** — `phase1_process_packages_classes()`: extracts packages, classes, attributes and enumerations from the XML tree
2. **Phase 2** — `phase2_process_connectors()`: processes associations, generalizations and diagram relationships that reference the objects created in phase 1

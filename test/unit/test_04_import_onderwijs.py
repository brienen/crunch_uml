...
def test_import_onderwijs():
    ...
    assert schema.get_attribute("EAID_dstA8C8B3_BE1A_40bd_A4FF_980213D42E5C").primitive == 'Loopbaanstap'
    assert (
        schema.get_attribute("EAID_dstA8C8B3_BE1A_40bd_A4FF_980213D42E5C").type_class_id
        == "EAID_0E3DE26B_C535_4a03_98A4_8D36DC3D5297"
    )
    assert schema.get_attribute("EAID_D730A5E4_33C0_46e8_B3D5_8A5ADF0255B6").primitive == "Onderwijstype"
    assert (

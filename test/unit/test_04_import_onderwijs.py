...
def test_import_onderwijs():
    ...
    assert (
        schema.get_attribute("EAID_ADBA3E5C_CAAC_44f1_AE93_396D86091B42").primitive
        == "Datum"
    )
    assert (
        schema.get_attribute("EAID_9BCB2AB1_71BF_45e8_A456_E3C4641E0ECC").primitive
        == "int"
    )
    assert (
        schema.get_attribute("EAID_dstA8C8B3_BE1A_40bd_A4FF_980213D42E5C").primitive
        is None
    )
    assert (
    ...
    assert (
        schema.get_attribute("EAID_D730A5E4_33C0_46e8_B3D5_8A5ADF0255B6").primitive
        is None
    )
    assert (

...
1. Replace all instances of `crunch_uml` with the name of your project
    * These are the Python snake_case references (eg: `crunch_uml`)
1. Replace all instances of `crunch_uml` with the name of your project
    * These are the references to your project that will appear in URLs and are typically hyphenated (eg: `project-name`)
1. Replace all instances of `brienen` with the name of the author or owner of the project
